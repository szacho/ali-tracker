...
export default () => {
  return(
    <div className="information">
      <h2 className="information__header">Informacje</h2>
      ...
      <ul className="information__todo-list">
        TODO:
      ...
      <span className="information__author">&copy;2017 Michał Szachniewicz (<a className="information__git-link" href="https://github.com/szacho/ali-tracker">github</a>)</span>
    </div>
  );
}
